...
import com.mohiva.play.silhouette.api.services.{AvatarService, AuthInfoService, AuthenticatorService}
import com.mohiva.play.silhouette.api.util._
import com.mohiva.play.silhouette.impl.authenticators._
import com.mohiva.play.silhouette.impl.daos._
...
import com.mohiva.play.silhouette.impl.providers.oauth2.state.{DummyStateProvider, CookieStateSettings, CookieStateProvider}
...
import com.mohiva.play.silhouette.impl.providers.openid._
import model.User
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def configure() {
    ...
    bind[com.mohiva.play.silhouette.api.EventBus].toInstance(com.mohiva.play.silhouette.api.EventBus())
  }
  ...
  def provideEnvironment(
    ...
    eventBus: com.mohiva.play.silhouette.api.EventBus,
